...
private:
    ...
    // Calculate the distance between two SAX character.
    double get_distance(std::string a, std::string b);

    // generate the alphabet of training data
    void generate_alphabet();

    double compute_xi(double d);
